...
export const GET: APIRoute = async ({ props }) => {
  ...
  const svg = `
    <svg width="1200" height="630" viewBox="0 0 1200 630" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="92" y="160" fill="#006cac" font-size="32" font-family="PingFang SC, sans-serif">zhuzm Blog</text>
      <text x="92" y="270" fill="#282728" font-size="64" font-weight="700" font-family="PingFang SC, sans-serif">${title}</text>
      <text x="92" y="370" fill="#4b5563" font-size="30" font-family="PingFang SC, sans-serif">${description}</text>
      <text x="92" y="520" fill="#6b7280" font-size="24" font-family="PingFang SC, sans-serif">${post.id}</text>
    </svg>
  `;
